    ...
    <div class="min-h-screen bg-gray-100">
          ...
          <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              <img
                ...
                :src="
                  $page.props.auth.user.avatar != 'placeholder'
      ...
      <header v-if="$slots.header" class="bg-white shadow">
        ...
        <div
          ...
          class="py-4 text-center bg-indigo-900 lg:px-4"
        >
          <div
            style="background-color: #6875f5"
            class="flex items-center p-2 leading-none text-indigo-100 lg:rounded-full lg:inline-flex"
            role="alert"
          >
            <span
              class="flex px-2 py-1 mr-3 text-xs font-bold uppercase bg-indigo-500 rounded-full"
              >Success</span
            >
            <span class="flex-auto mr-2 font-semibold text-left">{{
