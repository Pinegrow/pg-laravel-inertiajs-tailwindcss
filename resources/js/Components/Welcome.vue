  ...
  <div>
    <div class="p-6 bg-white border-b border-gray-200 lg:p-8">
      ...
      <p class="mt-6 leading-relaxed text-gray-500">
        This SPA offers an all-in-one solution for managing users and roles,
        featuring an easy-to-use dashboard for administrators.
        <br />
      ...
      <div class="mt-5">
        ...
        User count:
        <span style="color: #6875f5">{{ $page.props.counts.userCount }}</span
        ><br />
        Role count:
        <span style="color: #6875f5">{{ $page.props.counts.roleCount }}</span>
      </div>
    </div>
    <div
